...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|MediaError|MediaKeyError|Navigator|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "classbuilder.dart", , E, {
  ...
  main: [function() {
    ...
    t1 = N.Logger_Logger("").get$onRecord();
    t2 = new D.LogPrintHandler(null, "%t\t%n\t[%p]:\t%m", "\n%e\n%x", "yyyy.mm.dd HH:mm:ss.SSS", P.print$closure());
    t3 = new D.StringTransformer("%t\t%n\t[%p]:\t%m", "\n%e\n%x", "yyyy.mm.dd HH:mm:ss.SSS", null);
    t4 = new T.DateFormat(null, null, null);
    t4._locale = T.Intl_verifiedLocale(null, T.DateFormat_localeExists$closure(), T.Intl__throwLocaleError$closure());
    t4.addPattern$1("yyyy.mm.dd HH:mm:ss.SSS");
    t3.dateFormat = t4;
    t2.transformer = t3;
    t1.listen$1(t2);
    D.log("Quick'n'Dirty logging is enabled.  Better to do it properly, though.", C.Level_INFO_800, null);
    E.Character_loadClassSelectorImages().then$1(new E.main_closure());
  }, "call$0", "main$closure", 0, 0, 2],
  main_closure: {
    "^": "Closure:15;",
    call$1: function(_) {
      $.characters = [E.Character$("Alchemist", "Rogue"), E.Character$("Arcane Warrior", "Mage"), E.Character$("Assassin", "Rogue"), E.Character$("Elementalist", "Mage"), E.Character$("Hunter", "Rogue"), E.Character$("Katari", "Warrior"), E.Character$("Keeper", "Mage"), E.Character$("Legionaire", "Warrior"), E.Character$("Necromancer", "Mage"), E.Character$("Reaver", "Rogue"), E.Character$("Templar", "Warrior")];
    }
  },
  Character: {
    "^": "Object;name>,id,abilities,attributes,classType,charCard,charCardGrey,charCardDiv",
    getSpriteInfo$4: function(infoList, type, grey, small) {
      var t1 = {};
      D.log("getSpriteInfo() - char:" + this.name + ", type:" + type + ", variant:" + grey + ", small:" + small, C.Level_FINE_500, null);
      t1.image_0 = null;
      J.forEach$1$ax(infoList, new E.Character_getSpriteInfo_closure(t1, this, type, grey, small));
      return t1.image_0;
    },
    getSpriteInfo$2: function(infoList, type) {
      return this.getSpriteInfo$4(infoList, type, false, true);
    },
    getSpriteInfo$3: function(infoList, type, grey) {
      return this.getSpriteInfo$4(infoList, type, grey, true);
    },
    setupClassSelectorImage$0: function() {
      var newLi, t1, t2, charName;
      $.classSelectorList = document.querySelector("#classSelector ul");
      newLi = document.createElement("li", null);
      t1 = J.getInterceptor$x(newLi);
      t2 = t1.get$onMouseEnter(newLi);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.Character_setupClassSelectorImage_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1.get$onMouseLeave(newLi);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.Character_setupClassSelectorImage_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = t1.get$onClick(newLi);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.Character_setupClassSelectorImage_closure1(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.charCardDiv = document.createElement("div", null);
      this.changeClassSelectorImage$0();
      newLi.appendChild(this.charCardDiv);
      charName = document.createElement("p", null);
      charName.textContent = this.name;
      newLi.appendChild(charName);
      J.get$children$x($.classSelectorList).add$1(0, newLi);
    },
    changeClassSelectorImage$1$active: function(active) {
      var t1, t2;
      t1 = $.selectedChar === this || active === true;
      t2 = this.id;
      if (t1) {
        D.log(H.S(t2) + " set classSelectorImage to active", C.Level_INFO_800, null);
        J.set$width$x(this.charCardDiv.style, J.$add$ns(J.toString$0(this.charCard.width), "px"));
        J.set$height$x(this.charCardDiv.style, J.$add$ns(J.toString$0(this.charCard.height), "px"));
        J.set$background$x(this.charCardDiv.style, "url(packages/classbuilder/images/content/classImages/spritesheets/character-cards.png) no-repeat -" + H.S(this.charCard.x) + "px -" + H.S(this.charCard.y) + "px");
      } else {
        D.log(H.S(t2) + " set classSelectorImage to inactive", C.Level_INFO_800, null);
        J.set$width$x(this.charCardDiv.style, J.$add$ns(J.toString$0(this.charCardGrey.width), "px"));
        J.set$height$x(this.charCardDiv.style, J.$add$ns(J.toString$0(this.charCardGrey.height), "px"));
        J.set$background$x(this.charCardDiv.style, "url(packages/classbuilder/images/content/classImages/spritesheets/character-cards.png) no-repeat -" + H.S(this.charCardGrey.x) + "px -" + H.S(this.charCardGrey.y) + "px");
      }
    },
    changeClassSelectorImage$0: function() {
      return this.changeClassSelectorImage$1$active(null);
    },
    Character$2: function($name, classType) {
      var t1, t2;
      t1 = this.name;
      D.log("Character:const() - " + t1, C.Level_FINE_500, null);
      t1 = t1.toLowerCase();
      t2 = H.JSSyntaxRegExp_makeNative(" ", false, true, false);
      H.checkString("_");
      this.id = H.stringReplaceAllUnchecked(t1, new H.JSSyntaxRegExp(" ", t2, null, null), "_");
      this.charCard = this.getSpriteInfo$2($.get$Character_charCardsInfo(), "card");
      this.charCardGrey = this.getSpriteInfo$3($.get$Character_charCardsInfo(), "card", true);
      this.setupClassSelectorImage$0();
    },
    static: {"^": "Character_charCardsInfo", Character$: function($name, classType) {
        var t1 = new E.Character($name, null, [], [], classType, null, null, null);
        t1.Character$2($name, classType);
        return t1;
      }, Character_loadClassSelectorImages: function() {
        var e, charCardsJsonFuture, t1;
        e = document.createElement("img", null);
        J.set$src$x(e, "packages/classbuilder/images/content/classImages/spritesheets/character-cards.png");
        $.charCards = e;
        charCardsJsonFuture = W.HttpRequest_getString("packages/classbuilder/images/content/classImages/spritesheets/character-cards.json", null, null).then$1(new E.Character_loadClassSelectorImages_closure());
        t1 = J.get$onLoad$x($.charCards);
        return P.Future_wait([t1.get$first(t1), charCardsJsonFuture], false).then$1(new E.Character_loadClassSelectorImages_closure0());
      }}
  },
  Character_getSpriteInfo_closure: {
    "^": "Closure:15;box_0,this_1,type_2,grey_3,small_4",
    call$1: function(spriteInfo) {
      var t1, t2, t3, t4;
      t1 = J.getInterceptor$asx(spriteInfo);
      if (J.contains$1$asx(t1.$index(spriteInfo, "filename"), this.this_1.id) === true && J.contains$1$asx(t1.$index(spriteInfo, "filename"), this.type_2) === true && J.contains$1$asx(t1.$index(spriteInfo, "filename"), "grayOverlay") === this.grey_3 && J.contains$1$asx(t1.$index(spriteInfo, "filename"), "small") === this.small_4) {
        D.log("Found sprite in spriteInfo", C.Level_FINE_500, null);
        t2 = J.$index$asx(t1.$index(spriteInfo, "frame"), "x");
        t3 = J.$index$asx(t1.$index(spriteInfo, "frame"), "y");
        t4 = J.$index$asx(t1.$index(spriteInfo, "frame"), "w");
        t1 = J.$index$asx(t1.$index(spriteInfo, "frame"), "h");
        D.log("SpriteImage:const() - " + H.S(t2) + " " + H.S(t3) + " " + H.S(t4) + " " + H.S(t1), C.Level_FINE_500, null);
        this.box_0.image_0 = new E.SpriteImage(t2, t3, t4, t1);
      }
    }
  },
  Character_setupClassSelectorImage_closure: {
    "^": "Closure:15;this_0",
    call$1: function(_) {
      this.this_0.changeClassSelectorImage$1$active(true);
    }
  },
  Character_setupClassSelectorImage_closure0: {
    "^": "Closure:15;this_1",
    call$1: function(_) {
      this.this_1.changeClassSelectorImage$0();
    }
  },
  Character_setupClassSelectorImage_closure1: {
    "^": "Closure:15;this_2",
    call$1: function(_) {
      $.selectedChar = this.this_2;
      J.forEach$1$ax($.characters, new E.Character_setupClassSelectorImage__closure());
    }
  },
  Character_setupClassSelectorImage__closure: {
    "^": "Closure:15;",
    call$1: function($char) {
      $char.changeClassSelectorImage$0();
    }
  },
  Character_loadClassSelectorImages_closure: {
    "^": "Closure:17;",
    call$1: function(fileContents) {
      var t1;
      D.log("charCards info loaded", C.Level_INFO_800, null);
      t1 = J.$index$asx(C.JsonCodec_null_null.decode$1(fileContents), "frames");
      $.Character_charCardsInfo = t1;
      D.log(J.toString$0(t1), C.Level_FINE_500, null);
    }
  },
  Character_loadClassSelectorImages_closure0: {
    "^": "Closure:15;",
    call$1: function(_) {
      D.log("charCards loaded", C.Level_INFO_800, null);
    }
  },
  SpriteImage: {
...
["intl", "package:intl/intl.dart", , T, {
  ...
  }, "call$1", "Intl__throwLocaleError$closure", 2, 0, 1],
  ...
  DateFormat: {
    ...
    static: {"^": "DateFormat_ABBR_MONTH,DateFormat_DAY,DateFormat_ABBR_WEEKDAY,DateFormat_WEEKDAY,DateFormat_ABBR_STANDALONE_MONTH,DateFormat_STANDALONE_MONTH,DateFormat_NUM_MONTH,DateFormat_NUM_MONTH_DAY,DateFormat_NUM_MONTH_WEEKDAY_DAY,DateFormat_ABBR_MONTH_DAY,DateFormat_ABBR_MONTH_WEEKDAY_DAY,DateFormat_MONTH,DateFormat_MONTH_DAY,DateFormat_MONTH_WEEKDAY_DAY,DateFormat_ABBR_QUARTER,DateFormat_QUARTER,DateFormat_YEAR,DateFormat_YEAR_NUM_MONTH,DateFormat_YEAR_NUM_MONTH_DAY,DateFormat_YEAR_NUM_MONTH_WEEKDAY_DAY,DateFormat_YEAR_ABBR_MONTH,DateFormat_YEAR_ABBR_MONTH_DAY,DateFormat_YEAR_ABBR_MONTH_WEEKDAY_DAY,DateFormat_YEAR_MONTH,DateFormat_YEAR_MONTH_DAY,DateFormat_YEAR_MONTH_WEEKDAY_DAY,DateFormat_YEAR_ABBR_QUARTER,DateFormat_YEAR_QUARTER,DateFormat_HOUR24,DateFormat_HOUR24_MINUTE,DateFormat_HOUR24_MINUTE_SECOND,DateFormat_HOUR,DateFormat_HOUR_MINUTE,DateFormat_HOUR_MINUTE_SECOND,DateFormat_HOUR_MINUTE_GENERIC_TZ,DateFormat_HOUR_MINUTE_TZ,DateFormat_HOUR_GENERIC_TZ,DateFormat_HOUR_TZ,DateFormat_MINUTE,DateFormat_MINUTE_SECOND,DateFormat_SECOND,DateFormat__matchers", DateFormat_localeExists: [function(localeName) {
      ...
      }, "call$1", "DateFormat_localeExists$closure", 2, 0, 12], DateFormat__fieldConstructors: function() {
...
["logging_handlers_shared", "package:logging_handlers/logging_handlers_shared.dart", , D, {
  "^": "",
  log: function(message, level, loggerName) {
    N.Logger_Logger("").log$2(level, message);
  },
  LogPrintHandler: {
    "^": "Object:27;transformer,messageFormat,exceptionFormatSuffix,timestampFormat,printFunc",
    printFunc$1: function(arg0) {
      return this.printFunc.call$1(arg0);
    },
    call$1: function(logRecord) {
      this.printFunc$1(this.transformer.transform$1(0, logRecord));
    },
    $isFunction: true
  },
  StringTransformer: {
    "^": "Object;messageFormat,exceptionFormatSuffix,timestampFormat,dateFormat",
    transform$1: function(_, logRecord) {
      var formatString = this.messageFormat;
      formatString = J.get$error$x(logRecord) == null ? formatString : formatString + this.exceptionFormatSuffix;
      return H.stringReplaceAllFuncUnchecked(formatString, $.get$StringTransformer__regexp(), new D.StringTransformer_transform_closure(this, logRecord), null);
    },
    static: {"^": "StringTransformer_LEVEL,StringTransformer_MESSAGE,StringTransformer_NAME,StringTransformer_TIME,StringTransformer_SEQ,StringTransformer_EXCEPTION,StringTransformer_EXCEPTION_TEXT,StringTransformer_TAB,StringTransformer_NEW_LINE,StringTransformer_DEFAULT_MESSAGE_FORMAT,StringTransformer_DEFAULT_EXCEPTION_FORMAT,StringTransformer_DEFAULT_DATE_TIME_FORMAT,StringTransformer__regexp"}
  },
  StringTransformer_transform_closure: {
    "^": "Closure:15;this_0,logRecord_1",
    call$1: function(match) {
      var t1, t2, exception;
      if (match.get$groupCount() === 1)
        switch (match.group$1(0)) {
          case "%p":
            return this.logRecord_1.get$level().name;
          case "%m":
            return J.get$message$x(this.logRecord_1);
          case "%n":
          ...
          case "%t":
            ...
            t1.get$time();
            try {
              t2 = this.this_0.dateFormat.format$1(0, t1.time);
              return t2;
            } catch (exception) {
              if (!!J.getInterceptor(H.unwrapException(exception)).$isUnimplementedError)
                return t1.time.toString$0(0);
              else
                throw exception;
            }
            ...
            break;
          case "%s":
            return C.JSInt_methods.toString$0(this.logRecord_1.get$sequenceNumber());
          case "%x":
          case "%e":
            t1 = this.logRecord_1;
            t2 = J.getInterceptor$x(t1);
            if (t2.get$error(t1) != null)
              return J.toString$0(t2.get$error(t1));
            break;
        }
      return "";
    }
...
Isolate.$lazy($, "charCardsInfo", "Character_charCardsInfo", "get$Character_charCardsInfo", function() {
  return [];
});
...
Isolate.$lazy($, "_regexp", "StringTransformer__regexp", "get$StringTransformer__regexp", function() {
  return new H.JSSyntaxRegExp("(%p|%m|%n|%t|%s|%x|%e)", H.JSSyntaxRegExp_makeNative("(%p|%m|%n|%t|%s|%x|%e)", false, true, false), null, null);
});
...
//# sourceMappingURL=classbuilder.dart.js.map
